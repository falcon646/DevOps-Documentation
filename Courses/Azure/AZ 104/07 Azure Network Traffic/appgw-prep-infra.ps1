...
$region = "eastus"
$username = "ashwin" #username for the VM
$plainPassword = "Ashwin@989" #your VM password
...
## below 'Set-AzVMExtension @Params' command wont work because we have changed the username as password.
## you can manually login to the jumpbox and run the shell script from there
# script link : https://raw.githubusercontent.com/rithinskaria/kodekloud-az500/main/000-Code%20files/AppGateway/jumpbox.sh
# dont forget to update the username and passsword in the shell script to what you have mentioned here
# or use the script nginx_setup_script.sh from current folder
